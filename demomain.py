...
apikey_text_to_speech = 'NcWhEvZGEWCHOrPxN1OH7jmGX2Hp8RJSV32gmu8h2AGZ'
url_text_to_speech = 'https://api.eu-gb.text-to-speech.watson.cloud.ibm.com/instances/bd883762-0a55-4fc1-a699-f6620a942b2e'
...
#
    ...
    def seekAttentionState(self):
        ...
        #Emergency state
            ...
            sendSMS()#sendSMS(self.username, self.contactNumber)
            sys.exit()
